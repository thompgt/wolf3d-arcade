...
> Status: **Phase 2 complete** — raycaster and procedural textures are up.
> You can walk level 1 with textured walls, correct perspective and solid
> collision. Doors do not open yet. See [WORKPLAN.md](WORKPLAN.md) for what
> comes next.

![Textured corridor in level 1](docs/phase2.png)
